...
class ModeAnalysis:
    ...
    def run_3D(self,inital_guess=None):
        """
        ...
        -----------
        inital_guess : array    
            The initial guess for the crystal equilibrium positions. If None, then the initial guess will be generated by the 
            find_scaled_lattice_guess_3D method. 
        ...
        self.generate_crystal_3D(initial_guess=inital_guess)    
    ...
    def generate_crystal_3D(self,attempts=np.linspace(.1, 1, 25)[::-1],initial_guess=None):
        """
